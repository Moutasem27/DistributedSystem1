 ...
 * @author Moutasem
 */
public class SecondNodeGUI extends javax.swing.JFrame {
    ...
    public SecondNodeGUI() {
        try {
            ...
            Logger.getLogger(SecondNodeGUI.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
...
private  void receiveMessages(DataInputStream input) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SecondNodeGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new SecondNodeGUI().setVisible(true);
            }
            });     
    }
