 ...
 * @author Moutasem
 */
public class ThirdNodeGUI extends javax.swing.JFrame {
    ...
    public ThirdNodeGUI() {
        try {
            ...
            Logger.getLogger(ThirdNodeGUI.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
...
private  void receiveMessages(DataInputStream input) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ThirdNodeGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new ThirdNodeGUI().setVisible(true);
            }
            });     
    }
