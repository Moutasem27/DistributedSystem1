 ...
 * @author Moutasem
 */
public class FourthNodeGUI extends javax.swing.JFrame {
    ...
    public FourthNodeGUI() {
        try {
            ...
            Logger.getLogger(FourthNodeGUI.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
...
private  void receiveMessages(DataInputStream input) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new FourthNodeGUI().setVisible(true);
            }
            });     
    }
